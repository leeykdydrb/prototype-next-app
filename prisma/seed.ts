...
const SEED_DATA = {
  ...
  menus: [
    { id: 1, title: '대시보드', path: '/dashboard', icon: 'Dashboard', order: 1, parentId: null, isSystem: true },
    { id: 2, title: '설비 관리', path: null, icon: 'Engineering', order: 2, parentId: null, isSystem: true },
    { id: 3, title: '설비 목록', path: '/equipment', icon: 'Engineering', order: 3, parentId: 2, isSystem: true },
    { id: 4, title: '설비 등록', path: '/equipment/new', icon: 'Engineering', order: 4, parentId: 2, isSystem: true },
    { id: 5, title: '보고서', path: '/reports', icon: 'Assessment', order: 5, parentId: null, isSystem: true },
    { id: 6, title: '설정', path: null, icon: 'Settings', order: 6, parentId: null, isSystem: true },
    { id: 7, title: '시스템 관리', path: null, icon: 'SystemSettings', order: 9, parentId: null, isSystem: true },
    { id: 8, title: '사용자 관리', path: '/admin/users', icon: 'People', order: 1, parentId: 7, isSystem: true },
    { id: 9, title: '코드 관리', path: '/admin/codes', icon: 'Code', order: 2, parentId: 7, isSystem: true },
    { id: 10, title: '권한 관리', path: '/admin/permissions', icon: 'Security', order: 3, parentId: 7, isSystem: true },
    { id: 11, title: '역할 관리', path: '/admin/roles', icon: 'Groups', order: 4, parentId: 7, isSystem: true },
    { id: 12, title: '메뉴 관리', path: '/admin/menus', icon: 'Menu', order: 5, parentId: 7, isSystem: true },
    { id: 13, title: '장비 제어', path: '/devicecontrol', icon: 'Engineering', order: 7, parentId: null, isSystem: false },
    { id: 14, title: '디바이스 관리', path: '/device', icon: 'Settings', order: 8, parentId: null, isSystem: false },
  ],
